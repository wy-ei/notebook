...
![text=渲染树的构建过程（图片来自 Chrome developer）]({{site.images_dir}}/16-9-24/93321516.jpg)
...
![text=Web 页面渲染流程]({{site.images_dir}}/16-12-24/40084229-file_1482587915128_12523.png)
...
![text=每一帧浏览器可能要进行的工作]({{site.images_dir}}/16-12-20/54507285-file_1482230407662_af99.png)
...
![]({{site.images_dir}}/16-12-20/1671394-file_1482238561972_7546.png)
...
![text=不需要重排]({{site.images_dir}}/16-12-24/2354143-file_1482582976272_412e.png)


同样的，如果修改了一个都不需要进行重绘的属性，那么可以跳过 Layout 和 Paint 这两个步骤，此时只需要要进行图层的合并操作就能得到新一帧的图片。

![text=不需要重排和重绘]({{site.images_dir}}/16-12-24/94818326-file_1482583111284_433.png)
...
![text=引发了强制性同步布局]({{site.images_dir}}/16-11-11/319890.jpg)
...
![text=分离读写后]({{site.images_dir}}/16-11-11/147743.jpg)
...
![]({{site.images_dir}}/16-12-22/60022094-file_1482378522505_106ef.png)

不幸的是这几个 fixed 定位的元素和整个网页位于同一个图层：

![]({{site.images_dir}}/16-12-22/43431174-file_1482378837920_9983.png)
...
![]({{site.images_dir}}/16-12-21/86844237-file_1482313382826_1300.png)
...
![text=每个列表项都是一个图层]({{site.images_dir}}/16-12-21/2526768-file_1482317204542_10f11.png)

这是一个城市选择页，这个页面中的每一项都使用了 `transform:translateZ(0);`  强制提升至了单独的图层，滚动列表，并录制了一段 Timeline。

![text=优化前]({{site.images_dir}}/16-12-21/29285897-file_1482317682421_51ec.png)
...
![text=优化后]({{site.images_dir}}/16-12-21/6248079-file_1482317852508_1146d.png)
...
![]({{site.images_dir}}/16-12-22/29653560-file_1482384714959_15f64.gif)
...
![text=Instagram 登录页的背景色渐变效果]({{site.images_dir}}/16-12-21/18081357-file_1482309109052_180e1.png)
...
![]({{site.images_dir}}/16-12-22/28220586-file_1482393564393_826e.png)
